...
module div(
	...
	reg[31:0] opdata1_when_start;
	reg[31:0] opdata2_when_start;
			...
			`DivFree:			begin               //DivFree״̬
				if(start_i == `DivStart && annul_i == 1'b0) begin
					if(opdata2_i == `ZeroWord) begin
						...
						divisor <= temp_op2;
						opdata1_when_start <= opdata1_i;
						opdata2_when_start <= opdata2_i;
					end
				end else begin
					ready_o <= `DivResultNotReady;
					result_o <= {`ZeroWord,`ZeroWord};
		  	...
		  	`DivOn:				begin               //DivOn״̬
				if(annul_i == 1'b0) begin
					if(cnt != 6'b100000) begin
						...
						state <= `DivEnd;
						cnt <= 6'b000000;
						opdata1_when_start <= 32'd0;
						opdata2_when_start <= 32'd0;
					end
				end else begin
					state <= `DivFree;
				end
